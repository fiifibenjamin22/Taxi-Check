...
const routing_config_routes_1 = require("./domain/routes/common/routing-config.routes");
...
class App {
    ...
    config() {
        this.app.use(express_1.default.json({ limit: '50mb' }), express_1.default.urlencoded({
            extended: false, limit: '50mb',
            parameterLimit: 50000
        }), cors_1.default());
        new database_config_1.DatabaseConfig();
        new routing_config_routes_1.RoutingConfig(this.app);
    }
}
exports.default = App;
new App().start();
