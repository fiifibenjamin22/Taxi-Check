...
import { Body, Controller, Post, Route, Tags, Request, Res, TsoaResponse, SuccessResponse } from 'tsoa';
...
export class UssdController extends Controller {
    ...
    @Post('/ussd')
    public async initiateUssd(@Request() request: express.Request, @SuccessResponse() res: TsoaResponse<200, string>): Promise<void> {
