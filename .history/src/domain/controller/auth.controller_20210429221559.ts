...
import { Route, Controller, Get, Body, SuccessResponse, Post, Tags, Res, TsoaResponse, Response, Query, Delete } from "tsoa";
...
export class AuthController extends Controller {
    ...
    @Delete('/delete')
    public async delete(@Body() userId: string): Promise<void> {
