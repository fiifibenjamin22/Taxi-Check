import { Body, Controller, Get, Post, Query, Res, Route, SuccessResponse, Response, Tags, TsoaResponse, Delete } from "tsoa";
...
export class DriverController extends Controller {
    ...
    @Delete('/delete')
    public async delete(@Body() driverId: string): Promise<void> {
